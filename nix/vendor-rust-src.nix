...
let
  outputHashes = {
    x86_64-linux = "sha256-uTKgFzrTpJR7REaUnxFF3tEVrcp4wL4BzUNtmOJmjb0=";
    aarch64-linux = "sha256-uTKgFzrTpJR7REaUnxFF3tEVrcp4wL4BzUNtmOJmjb0=";
    aarch64-darwin = "sha256-xbbwhxDpdc1IzQsz/272TS6DxyGXGBg2b0woshXMlzY=";
  };
in
