...
let
  outputHashes = {
    x86_64-linux = "sha256-arzqn/LRhGVDagnJiYfyQVtYpvSy3uPRqR/CME9L9KU=";
    aarch64-linux = "sha256-arzqn/LRhGVDagnJiYfyQVtYpvSy3uPRqR/CME9L9KU=";
    aarch64-darwin = "sha256-ctKOk2Hqj9VanxJ3R2UK0AthQy+FosGTaWpjUXkM+4g=";
  };
in
