...
let
  outputHashes = {
    x86_64-linux = "sha256-Y/hM0PIqWwfC4twOm15Sc6gcVysqw6j+EovkguPlnfs=";
    aarch64-linux = "sha256-Y/hM0PIqWwfC4twOm15Sc6gcVysqw6j+EovkguPlnfs=";
    aarch64-darwin = "sha256-Ot3PzbE+ADTeULDq+OeDAR2qZVonpWGhN2dMiaUbbZ8=";
  };
in
