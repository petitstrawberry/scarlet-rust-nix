...
let
  outputHashes = {
    x86_64-linux = "sha256-Xo0me3m/fKvGxm49ieqSS2PnFaE8u3LFIW3gnGhAfkg=";
    aarch64-linux = "sha256-Xo0me3m/fKvGxm49ieqSS2PnFaE8u3LFIW3gnGhAfkg=";
    aarch64-darwin = "sha256-7C/+RnyZum/irATQ7UOwb9HNTgosEwiFNVlUgh8HR7Q=";
  };
in
