...
let
  outputHashes = {
    x86_64-linux = "sha256-Cr6uUXKYRLpVapiFG8KTwx4bG6gVfbkCPUc+SkAssm8=";
    aarch64-linux = "sha256-Cr6uUXKYRLpVapiFG8KTwx4bG6gVfbkCPUc+SkAssm8=";
    aarch64-darwin = "sha256-R+/JXWZBJ9pgSGLs6MHjTagObmxb+55LEo57IxilMrk=";
  };
in
