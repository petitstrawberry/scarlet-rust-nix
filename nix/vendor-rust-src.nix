...
let
  outputHashes = {
    x86_64-linux = "sha256-dwYrxtKBj7X93hwgWhNVPRetqq3S75tWJdo5Yq3NaAc=";
    aarch64-linux = "sha256-dwYrxtKBj7X93hwgWhNVPRetqq3S75tWJdo5Yq3NaAc=";
    aarch64-darwin = "sha256-ri7oNh4C6e+zTLl5wC0+g6cL6BYH8Hwqc3myoQxndRI=";
  };
in
