...
let
  outputHashes = {
    x86_64-linux = "sha256-gKz/LeopgBZfW2UvghGVkz7o5Xk03ZQkI2myDYs9Zgw=";
    aarch64-linux = "sha256-gKz/LeopgBZfW2UvghGVkz7o5Xk03ZQkI2myDYs9Zgw=";
    aarch64-darwin = "sha256-n6JFpPH3qQQ2OQIXsPP32RgoRvp5u/sC3qDYhRvyJsM=";
  };
in
