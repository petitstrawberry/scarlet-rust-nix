...
let
  outputHashes = {
    x86_64-linux = "sha256-94Ltub2ofiiTuiPuFn5S+iqHfyvgtRO3bR5JkA6tHF8=";
    aarch64-linux = "sha256-94Ltub2ofiiTuiPuFn5S+iqHfyvgtRO3bR5JkA6tHF8=";
    aarch64-darwin = "sha256-/RCgxUncARqGGgnxTz8XrCkcQv2W6vJrTVOyU4+CZ5Y=";
  };
in
