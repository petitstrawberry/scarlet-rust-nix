...
let
  outputHashes = {
    x86_64-linux = "sha256-RCTL7ki8YG8e+kGOoDVmwzUNx3KPwDHdiHL3nNxcy+4=";
    aarch64-linux = "sha256-RCTL7ki8YG8e+kGOoDVmwzUNx3KPwDHdiHL3nNxcy+4=";
    aarch64-darwin = "sha256-38FZirA6eMf3mpgMuxDsfG/TOfMJSyfjvR6qBmrMvHU=";
  };
in
