...
let
  outputHashes = {
    x86_64-linux = "sha256-zck9viKl3BzM7K5GtSGGlIdBRBab31idw8P/1KMny/c=";
    aarch64-linux = "sha256-zck9viKl3BzM7K5GtSGGlIdBRBab31idw8P/1KMny/c=";
    aarch64-darwin = "sha256-gzjvbO+/a9UBHl0SUX8dNnNBnvgTFRXBTEUDZ9fpNpA=";
  };
in
