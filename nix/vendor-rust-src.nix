...
let
  outputHashes = {
    x86_64-linux = "sha256-r1qomaPe924rS1ACWWAUhgHQ8QOBaC/B2MFaUXLwp8A=";
    aarch64-linux = "sha256-r1qomaPe924rS1ACWWAUhgHQ8QOBaC/B2MFaUXLwp8A=";
    aarch64-darwin = "sha256-eCdbhXfbE3eZLMk2bg32eypjI3STBwSBHaACiLyV+wE=";
  };
in
